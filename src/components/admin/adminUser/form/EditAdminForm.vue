    ...
    <el-dialog v-model="visible" title="编辑管理员" width="500px" @close="handleClose">
        <el-form :model="localFormData" label-width="100px">
            ...
            <el-form-item label="状态">
                ...
                <div v-if="isSuperAdmin" class="el-form-item__error">超级管理员状态不可修改</div>
            </el-form-item>
...
const isSuperAdmin = computed(() => localFormData.role_id === 1)
...
const submit = async () => {
    try {
        ...
        if (isSuperAdmin.value) {
            delete submitData.status // 超级管理员不提交状态修改
        }
        
        await request.put(`/api/admin/manage/${localFormData.id}`, submitData)
